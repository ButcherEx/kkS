...
#include "event/Event_WIN32.h"
#elif defined(POCO_VXWORKS)
#include "event/Event_VX.h"
#else
#include "event/Event_POSIX.h"
#endif
...
class  Event: private EventImpl, private boost::noncopyable
...
public:
	...
	int wait(int32_t milliseconds);
		/// Waits for the event to become signalled.
		/// return E_OK if event become signalled  
		/// return E_TIMEOUT  does not become signalled 
...
inline int Event::wait(int32_t milliseconds)
{
...
inline bool Event::tryWait(int32_t milliseconds)
{
