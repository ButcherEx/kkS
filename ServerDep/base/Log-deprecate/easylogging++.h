...
#if _ELPP_STACKTRACE && !defined(_ELPP_OS_WINDOWS)
#   include <cxxabi.h>
#   include <execinfo.h>
...
#      include <mutex>
#if !defined(_ELPP_USE_BOOST_THREAD)
#      include <thread>
#   else
#      if _ELPP_OS_UNIX
#         include <pthread.h>
#      endif  // _ELPP_OS_UNIX
#endif // _ELPP_USE_BOOST_THREAD
...
class StackTrace {
public:
	StackTrace(std::ostream& os = std::cout){
