...
#define AssertSpecial(expr)  {if(!(expr)){__assert__(__FILE__,__FUNCTION__,__LINE__,#expr, false);}}
#define AssertSpecialEx(expr,msg)  {if(!(expr)){__assert__(__FILE__,__FUNCTION__,__LINE__,msg, false);}}
